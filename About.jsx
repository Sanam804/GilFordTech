            ...
            <div className="container py-5">
                <div className="row g-5">
                    ...
                    <div className="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                        ...
                        <Link href="" className="btn btn-secondary rounded-pill px-5 py-3 text-white">More Details</Link>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div className="team-content">
                            <div className="team-img-icon">
                                ...
                                <div className="team-icon d-flex justify-content-center pb-4">
                                    ...
                                    <Link className="btn btn-square btn-secondary text-white rounded-circle m-1" href=""><i className="fab fa-twitter"></i></Link>
                                    <Link className="btn btn-square btn-secondary text-white rounded-circle m-1" href=""><i className="fab fa-instagram"></i></Link>
                                    <Link className="btn btn-square btn-secondary text-white rounded-circle m-1" href=""><i className="fab fa-linkedin-in"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
